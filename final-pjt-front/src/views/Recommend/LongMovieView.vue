<template>
  <div>
    <div class='container'>
        ...
        <h2 class="text-center" style="color: #4C0070;">상영시간이 긴 영화</h2>
        <p class="text-center" style="color: #4C0070;">최소 2.5시간 이상의 영화를 만나보세요!</p>
        <br>
        <div v-for="(movie, idx) in longmovies" :key="idx">
