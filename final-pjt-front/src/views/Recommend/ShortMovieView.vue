<template>
  <div>
    <div class='container'>
        ...
        <h2 class="text-center" style="color: #4C0070;">킬링타임용 1시간 영화</h2>
        <p class="text-center" style="color: #4C0070;">1시간 미만의 짧은 영화를 만나보세요!</p>
        <br>
        <div v-for="(movie, idx) in shortmovies" :key="idx">
